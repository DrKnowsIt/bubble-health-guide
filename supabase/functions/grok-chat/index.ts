...
serve(async (req) => {
  ...
  try {
    ...
    const messages = [
      {
        role: 'system',
        content: `You are DrKnowsIt, an AI health assistant. You provide helpful, accurate, and empathetic health information while always emphasizing that you cannot replace professional medical advice. 
