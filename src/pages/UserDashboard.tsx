...
import { AddFamilyMemberDialog } from '@/components/modals/AddFamilyMemberDialog';
...
import { MobileEnhancedChatInterface } from '@/components/chat/MobileEnhancedChatInterface';
...
import { TabletChatInterface } from '@/components/chat/TabletChatInterface';
...
// Desktop Health Tab Component
const HealthDesktopTab = ({ selectedUser }: { selectedUser: any }) => {
                ...
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      ...
                      "before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-primary-foreground/30 before:to-transparent",
                      ...
                      (currentConversationDiagnoses.some(d => d.confidence >= 0.7) && 
                       ...
                       !analysisLoading && hasHealthData)
                        ? "shadow-[0_0_20px_rgba(20,184,166,0.6)] ring-2 ring-teal-400/50 before:via-primary-foreground/40"
            ...
            <TabsContent value="chat" className="h-full mt-0 pt-0">
              ...
              <TabsContent value="health" className="h-full mt-0 pt-4">
                {isMobile ? (
                  ...
                  <HealthDesktopTab selectedUser={selectedUser} />
                )}
              </TabsContent>
