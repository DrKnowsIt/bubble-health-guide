...
export default function UserDashboard() {
  ...
  return <div className="min-h-screen bg-background">
      {/* Subscription Alert */}
      {!subscribed && <div className="bg-primary/10 border-b border-primary/20 p-3">
      ...
      <div className="flex-1 min-h-0">
        ...
        <div className="order-2 border-t border-border bg-background p-2 mt-auto">
              <TabsList className="w-full grid grid-cols-4">
                ...
                <TabsTrigger value="health" className={cn("flex flex-col items-center gap-1 py-2 relative", !hasAccess('basic') && "opacity-50")}>
                  <div className="relative">
        ...
        <div className="px-4 pt-6">
          ...
          <div className={cn("flex-1 overflow-hidden", isMobile ? "order-1" : "px-4 pb-6")}>
            ...
            <TabsContent value="overview" className="h-full mt-0 pt-4">
              <div className={cn("h-full overflow-y-auto", isMobile ? "p-4" : "")}>
                <SubscriptionGate requiredTier="basic" feature="Overview" description="View your health analytics and activity summary with a Basic or Pro subscription.">
