      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Important information about using DrBubbles</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
            ...
            <CardContent>
              <div className="bg-destructive/10 p-6 rounded-lg space-y-4">
                <p className="text-destructive font-bold text-lg">
                  DrBubbles is NOT a substitute for professional medical care, diagnosis, or treatment.
                </p>
                <ul className="list-disc list-inside text-destructive space-y-2">
                  <li>DrBubbles cannot diagnose medical conditions</li>
                  <li>DrBubbles cannot prescribe medications or treatments</li>
                  <li>DrBubbles cannot provide emergency medical care</li>
                  <li>DrBubbles responses are for educational purposes only</li>
                </ul>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="bg-warning/10 p-6 rounded-lg space-y-4">
                <p className="text-warning font-bold">
                  🚨 If you are experiencing a medical emergency, do NOT use DrBubbles.
                </p>
          ...
          <Card className="medical-card">
            <CardHeader>
              <CardTitle>What DrBubbles IS</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="bg-accent-light p-4 rounded-lg mb-4">
                <p className="text-accent-foreground font-medium">
                  DrBubbles is an educational health companion designed to help you understand 
          ...
          <Card className="medical-card">
            <CardHeader>
              <CardTitle>What DrBubbles is NOT</CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
          ...
          <Card className="medical-card">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">By using DrBubbles, you acknowledge that:</p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>You understand DrBubbles is for educational purposes only</li>
                <li>You will not rely solely on DrBubbles for medical decisions</li>
                ...
                <li>You will use DrBubbles as a supplementary tool, not a replacement for medical care</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="medical-card">
            ...
            <CardContent>
              <div className="bg-primary-light p-6 rounded-lg">
                <h3 className="font-semibold text-foreground mb-3">Best Practice for Using DrBubbles:</h3>
                <ol className="list-decimal list-inside text-muted-foreground space-y-2">
                  <li>Use DrBubbles to learn about health topics and organize your concerns</li>
                  <li>Prepare questions and summaries for your healthcare provider</li>
                  <li>Share DrBubbles-generated summaries with your doctor for their review</li>
          ...
          <Card className="medical-card">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                If you have questions about this disclaimer or DrBubbles' capabilities:
              </p>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">support@drbubbles.ai</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">1-800-DRBUBBLE</p>
                  </div>
                </div>
              </div>
            </CardContent>
