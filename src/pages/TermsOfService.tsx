      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          <Card className="medical-card">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using DrBubbles ("Service"), you accept and agree to be bound by the 
          ...
          <Card className="medical-card">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed mb-4">
                DrBubbles is an AI-powered health guidance platform designed to help users:
              </p>
            ...
            <CardContent>
              <div className="bg-warning/10 p-4 rounded-lg mb-4">
                <p className="text-warning font-medium">
                  ⚠️ IMPORTANT: DrBubbles is NOT a substitute for professional medical advice, 
                  diagnosis, or treatment.
                </p>
              </div>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>Always seek the advice of your physician or qualified healthcare provider</li>
                <li>Never disregard professional medical advice because of information from DrBubbles</li>
                <li>DrBubbles cannot diagnose conditions or prescribe medications</li>
          ...
          <Card className="medical-card">
            ...
            <CardContent>
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>DrBubbles and all related content are owned by our company and licensors</li>
            ...
            <CardContent>
              <div className="bg-muted/50 p-4 rounded-lg mb-4">
                <p className="text-sm text-muted-foreground font-medium">
                  To the maximum extent permitted by law, DrBubbles shall not be liable for any damages 
          ...
          <Card className="medical-card">
            ...
            <CardContent>
              ...
              <div className="space-y-2 text-muted-foreground">
                <p><strong>Email:</strong> legal@drbubbles.ai</p>
                <p><strong>Phone:</strong> 1-800-DRBUBBLE</p>
                <p><strong>Mail:</strong> DrBubbles Legal Department<br />123 Health Street<br />Medical City, MC 12345</p>
              </div>
            </CardContent>
          </Card>
        </div>
