...
This summary was generated by DrKnowsIt AI to help prepare you for your medical consultation. Always consult with qualified healthcare professionals for medical advice.`;
  ...
  const generateNextQuestion = useCallback(async (retryCount = 0) => {
    const maxRetries = 2;
    ...
    try {
      ...
      if (retryCount < maxRetries) {
        ...
        setTimeout(() => generateNextQuestion(retryCount + 1), 1000 * (retryCount + 1));
        return;
      }
        ...
        try {
          ...
          setDynamicQuestion({
            ...
            options: [
              ...
              "I have concerns about this area",
