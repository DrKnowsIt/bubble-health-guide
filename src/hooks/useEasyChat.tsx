...
This summary was generated by DrKnowsIt AI to help prepare you for your medical consultation. Always consult with qualified healthcare professionals for medical advice.`;
  ...
  const generateNextQuestion = useCallback(async () => {
    try {
      ...
      // Instead of completing session, use fallback questions based on conversation progress
      ...
      // Use different fallback based on conversation length
      const fallbackIndex = Math.min(conversationPath.length % fallbackQuestions.length, fallbackQuestions.length - 1);
      console.log('Using fallback question:', fallbackIndex);
      setDynamicQuestion(fallbackQuestions[fallbackIndex]);
    }
  }, [conversationPath, patientId, selectedAnatomy]);
