...
const features = [
  {
    ...
    description: "Engage in natural conversations with DrNorbit. Our AI understands medical terminology and provides clear, helpful responses to your health questions."
  },
  {
    icon: Mic,
    title: "Voice Mode",
    description: "Speak naturally with DrNorbit using our advanced voice recognition. Perfect for when you're on the go or prefer verbal communication."
  },
  {
    icon: FileText,
    title: "Auto Health Records",
    description: "DrNorbit automatically organizes your conversations into a comprehensive health profile, making it easy to track symptoms and concerns over time."
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description: "Get immediate guidance 24/7. DrNorbit is always available to help you understand health topics and prepare for medical appointments."
  }
];
