      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
            Get instant medical guidance through intelligent conversation. Chat or speak with DrBubble 
          ...
          <div className="mx-auto mt-6 max-w-3xl rounded-xl bg-warning/10 border border-warning/20 p-4">
            <p className="text-sm font-medium text-warning">
              ⚠️ Important: DrBubble is not a replacement for professional medical care. 
