...
export const AnatomySelector = ({ onSelectionComplete }: AnatomySelectorProps) => {
  const [shapes, setShapes] = useState<Shape[]>([
    ...
    { id: '5', name: 'Left Shoulder', x: 58, y: 19.67, width: 10.33, height: 7, rotation: 0 },
    { id: '6', name: 'Right Shoulder', x: 31.67, y: 19.67, width: 10.33, height: 7, rotation: 0 },
    { id: '7', name: 'Left Upper Arm', x: 68.33, y: 26.67, width: 8, height: 12, rotation: 0 },
    { id: '8', name: 'Right Upper Arm', x: 23.67, y: 26.67, width: 8, height: 12, rotation: 0 },
    { id: '9', name: 'Left Elbow', x: 70, y: 38.67, width: 6, height: 4, rotation: 0 },
    { id: '10', name: 'Right Elbow', x: 24, y: 38.67, width: 6, height: 4, rotation: 0 },
    { id: '11', name: 'Left Forearm', x: 72, y: 42.67, width: 7, height: 11, rotation: 0 },
    { id: '12', name: 'Right Forearm', x: 21, y: 42.67, width: 7, height: 11, rotation: 0 },
    { id: '13', name: 'Left Hand', x: 74, y: 53.67, width: 5, height: 6, rotation: 0 },
    { id: '14', name: 'Right Hand', x: 21, y: 53.67, width: 5, height: 6, rotation: 0 },
