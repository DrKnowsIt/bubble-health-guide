...
export const AnatomySelector = ({ onSelectionComplete }: AnatomySelectorProps) => {
  const [shapes, setShapes] = useState<Shape[]>([
    ...
    { id: '11', name: 'Left Forearm', x: 67.5, y: 42.67, width: 7, height: 11, rotation: 0 },
    { id: '12', name: 'Right Forearm', x: 25.5, y: 42.67, width: 7, height: 11, rotation: 0 },
    { id: '13', name: 'Left Hand', x: 69.5, y: 53.67, width: 5, height: 6, rotation: 0 },
    { id: '14', name: 'Right Hand', x: 25.5, y: 53.67, width: 5, height: 6, rotation: 0 },
